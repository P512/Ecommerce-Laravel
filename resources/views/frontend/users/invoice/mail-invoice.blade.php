...
<body>
    <div class="text-center">
        ...
        <p>
            Thank You For Purchasing With {{ $appSetting->website_name ?? "FlaWave" }}.
        </p>
    </div>
        ...
        <thead>
            <tr>
                <th width="50%" colspan="2">
                    <h2 class="text-start">{{ $appSetting->website_name ?? "FlaWave" }}</h2>
                </th>
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with FlaWave
    </p>
